...
from networks.ppcn import Net

parser = argparse.ArgumentParser(description='RGB denoising evaluation on SIDD benchmark dataset')

parser.add_argument('--input_dir', default='./Datasets/SIDD/test/SIDD/benchmark/mat', type=str, help='Directory of validation images')
...
parser.add_argument('--ensemble', default=True, help='using self_ensemble strategy')
