...
from model.ppcn import Net
import time 

torch.manual_seed(args.seed)
parser = argparse.ArgumentParser(description="CNCN")
parser.add_argument("--model", type=str, default='CNCN', help="Mode name")
parser.add_argument('--logdir', type=str, default='./pretrain/cncn_n10.pt', help="Path to pretrained model")
parser.add_argument("--test_data", type=str, default='./testsets/Set12', help='test on Set12, BSD68 and Urban100')
